...
import { Container as ContainerBase } from "component/misc/Layouts";
...
${tw`w-full bg-cover bg-center bg-no-repeat m-0  bg-white text-gray-900 shadow sm:rounded-lg flex justify-center flex-1 py-5 `}
...
const Heading = tw.h1`text-2xl xl:text-3xl text-white font-extrabold`;
...
const Form = tw.form`w-4/5 mx-auto max-w-sm`;
