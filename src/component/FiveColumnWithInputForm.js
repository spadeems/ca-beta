    ...
    <Container>
      <Content>
        <SixColumns>
          ...
          <Column>
            <ColumnHeading>FAQs</ColumnHeading>
            {/* <LinkList>
              <LinkListItem>
          ...
          <Column>
            <ColumnHeading>Privacy Policy</ColumnHeading>
            {/* <LinkList>
              <LinkListItem>
          ...
          <Column>
            <ColumnHeading>Terms of Service</ColumnHeading>
            {/* <LinkList>
              <LinkListItem>
                <Link href="#">GDPR</Link>
              </LinkListItem>
        ...
        <ThreeColRow>
          <LogoContainer>
            <LogoImg src={spadeemslogo} />
            <LogoText></LogoText>
          </LogoContainer>
          <CopywrightNotice> Copyright © 2021 SpadeEMS. All Rights Reserved.</CopywrightNotice>
          <SocialLinksContainer>
            <SocialLink href="https://www.facebook.com/spadeems29">
              <FacebookIcon />
            </SocialLink>
            <SocialLink href="https://twitter.com/EmsSpade/">
              <TwitterIcon />
            </SocialLink>
